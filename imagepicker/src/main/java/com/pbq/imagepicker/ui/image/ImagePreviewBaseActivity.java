...
public abstract class ImagePreviewBaseActivity extends ImageBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.pbq.imagepicker.R.layout.activity_image_preview);
        ...
        //初始化当前页面的状态
        mTitleCount.setText(getString(com.pbq.imagepicker.R.string.preview_image_count, mCurrentPosition + 1, mImageItems.size()));
    }
