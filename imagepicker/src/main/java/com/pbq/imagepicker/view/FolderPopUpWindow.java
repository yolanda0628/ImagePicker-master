...
public class FolderPopUpWindow extends PopupWindow implements View.OnClickListener {
    ...
    public FolderPopUpWindow(Context context, BaseAdapter adapter) {
        ...
        final View view = View.inflate(context, com.pbq.imagepicker.R.layout.pop_folder, null);
        masker = view.findViewById(com.pbq.imagepicker.R.id.masker);
        masker.setOnClickListener(this);
        marginView = view.findViewById(com.pbq.imagepicker.R.id.margin);
        marginView.setOnClickListener(this);
        listView = (ListView) view.findViewById(com.pbq.imagepicker.R.id.listView);
