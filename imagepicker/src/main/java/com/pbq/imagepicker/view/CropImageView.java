...
public class CropImageView extends ImageView {
    ...
    public CropImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, com.pbq.imagepicker.R.styleable.CropImageView);
        mMaskColor = a.getColor(com.pbq.imagepicker.R.styleable.CropImageView_cropMaskColor, mMaskColor);
        mBorderColor = a.getColor(com.pbq.imagepicker.R.styleable.CropImageView_cropBorderColor, mBorderColor);
        mBorderWidth = a.getDimensionPixelSize(com.pbq.imagepicker.R.styleable.CropImageView_cropBorderWidth, mBorderWidth);
        mFocusWidth = a.getDimensionPixelSize(com.pbq.imagepicker.R.styleable.CropImageView_cropFocusWidth, mFocusWidth);
        mFocusHeight = a.getDimensionPixelSize(com.pbq.imagepicker.R.styleable.CropImageView_cropFocusHeight, mFocusHeight);
        mDefaultStyleIndex = a.getInteger(com.pbq.imagepicker.R.styleable.CropImageView_cropStyle, mDefaultStyleIndex);
