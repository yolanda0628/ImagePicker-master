...
public class ImageGridAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (itemViewType == ITEM_TYPE_CAMERA) {
            convertView = LayoutInflater.from(mActivity).inflate(com.pbq.imagepicker.R.layout.adapter_camera_item, parent, false);
            ...
            if (convertView == null) {
                convertView = LayoutInflater.from(mActivity).inflate(com.pbq.imagepicker.R.layout.adapter_image_item, parent, false);
                convertView.setLayoutParams(new AbsListView.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, mImageSize)); //让图片是个正方形
            ...
            holder.cbCheck.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (holder.cbCheck.isChecked() && mSelectedImages.size() >= selectLimit) {
                        Toast.makeText(mActivity.getApplicationContext(), mActivity.getString(com.pbq.imagepicker.R.string.select_limit, selectLimit), Toast.LENGTH_SHORT).show();
